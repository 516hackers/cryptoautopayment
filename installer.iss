...
begin
  ...
  begin
    ...
    Font.Size := 18;
    Font.Style:= [fsBold];
    Font.Color:= $00237E1A;   // Dark green
    Left      := 0;
    Top       := 0;
    AutoSize  := True;
  end;
  ...
  begin
    ...
    Font.Color := $00FF0000;   // Blue (hex value)
  ...
  begin
    ...
    Font.Color := $00A01CC5;   // Purple (Instagram purple)
    Font.Style := [fsUnderline];
    Cursor     := crHand;
    Left       := 0;
    Top        := 308;
  ...
  begin
    ...
    Font.Size := 9;
    Font.Color:= $00006614;   // Dark green (from working code)
    Left     := 0;
    Top      := 172;
    Width    := 460;
    Height   := 140;
